...
import { v1ListFavorites } from "./v1-list-favorities";
import { v1ListHistoric } from "./v1-list-historic";
...
export default (fastify: FastifyInstance, opts: any, done: any) => {
  ...
  fastify.get("/me", v1Me);
  fastify.get("/me/history", v1ListHistoric);
  fastify.get("/me/favorites", v1ListFavorites);
